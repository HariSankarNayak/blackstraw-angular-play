(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_export_excel_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./services/export-excel.service */
      "./src/app/services/export-excel.service.ts");

      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(ete) {
        ...
        _createClass(AppComponent, [{
          ...
          value: function exportToExcel() {
            ...
            this.empPerformance.forEach(function (row) {
      ...
      AppComponent.ɵfac = function AppComponent_Factory(t) {
        return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_export_excel_service__WEBPACK_IMPORTED_MODULE_1__["ExportExcelService"]));
      };
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
          ...
          return [{
            type: _services_export_excel_service__WEBPACK_IMPORTED_MODULE_1__["ExportExcelService"]
          }];
        }, null);
      })();
      /***/
    ...
    /***/
    function srcAppServicesExportExcelServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ExportExcelService", function () {
      ...
      var exceljs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! exceljs */
      "./node_modules/exceljs/dist/exceljs.min.js");
      /* harmony import */


      var exceljs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(exceljs__WEBPACK_IMPORTED_MODULE_1__);
      /* harmony import */
      ...
      var ExportExcelService = /*#__PURE__*/function () {
        function ExportExcelService() {
          _classCallCheck(this, ExportExcelService);
        }

        _createClass(ExportExcelService, [{
          key: "exportExcel",
          value: function exportExcel(excelData) {
            //Title, Header & Data
            var title = excelData.title;
            var header = excelData.headers;
            var data = excelData.data; //Create a workbook with a worksheet

            var workbook = new exceljs__WEBPACK_IMPORTED_MODULE_1__["Workbook"]();
            var worksheet = workbook.addWorksheet('Sales Data'); //Add Row and formatting

            worksheet.mergeCells('C1', 'F4');
            var titleRow = worksheet.getCell('C1');
            ...
            var dateCell = worksheet.getCell('G1');
            dateCell.value = date;
            dateCell.font = {
              name: 'Calibri',
              size: 12,
            ...
            worksheet.addImage(myLogoImage, 'A1:B4'); //Blank Row
            ...
            var footerRow = worksheet.addRow(['Employee Sales Report Generated from example.com at ' + date]);
            ...
            worksheet.mergeCells("A".concat(footerRow.number, ":F").concat(footerRow.number)); //Generate & Save Excel File
      ...
      ExportExcelService.ɵfac = function ExportExcelService_Factory(t) {
        return new (t || ExportExcelService)();
      };

      ExportExcelService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ExportExcelService, [{
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\GitsTrails\exceljs-angular10\src\main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
